...
feature "hidden links" do
  ...
  context "regular users" do
    ...
    scenario "New ticket link is shown to a user without permission" do
      define_permission!(user, "view", project)
      visit project_path(project)
    ...
    scenario "Edit ticket link is hidden from a user without persmission" do
      define_permission!(user, "view", project)
      visit project_path(project)
      click_link ticket.title
    ...
    scenario "Delete ticket link is shown to a user without permission" do
      define_permission!(user, "view", project)
      visit project_path(project)
      click_link ticket.title
  ...
  context "admin users" do
    ...
    scenario "New ticket link is shown for admins" do
      visit project_path(project)
      assert_link_for "New Ticket"
    end
